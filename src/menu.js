...
import { joinUp, lift, selectParentNode, toggleMark } from 'prosemirror-commands'
...
export function buildMenuItems(schema) {
	...
	r.fullMenu = [
		...
		[r.wrapOrderedList, r.wrapUnorderedList, r.joinUpItem, r.liftItem, r.selectParentNodeItem]
	]
